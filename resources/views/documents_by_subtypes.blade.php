...
@section('content')
<div ng-controller="documentsSubtypesController" ng-init="document_type_id = {{$data['id']}}; document_subtype_id = {{$data['subtype']}};" style="margin-left: 100px; margin-top: 100px; margin-right: 100px;">
	<!--content-->
	<div class="content">
		<br/>
