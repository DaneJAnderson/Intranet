App.controller('documentsSubtypesController', ['$scope', '$http', '$rootScope', '$window', 'documentsService', 'utilityService', 'APP_Config', function($scope, $http, $rootScope, $window, documentsService, utilityService, APP_Config)
{
	console.log("START - documentsSubtypesController");
	...
	*/
	...
	angular.element(document).ready(function ()
	{
		...
		var type = $scope.document_subtype_id;
		
		
		documentsService.getDocumentBySubTypes(id, type).then(function(data)
		{
			console.log(data);
	...
	console.log("STOP - documentsSubtypesController");
}]);